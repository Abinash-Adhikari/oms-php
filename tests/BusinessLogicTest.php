...
class BusinessLogicTest extends TestCase
{
    ...
    public function testNormalizeProjectUrlAddsScheme()
    {
        $this->assertSame('https://example.com', normalize_project_url('example.com'));
        $this->assertSame('https://example.com/app', normalize_project_url('https://example.com/app'));
        $this->assertSame('http://legacy.test', normalize_project_url('  http://legacy.test  '));
        $this->assertNull(normalize_project_url(''));
        $this->assertNull(normalize_project_url('   '));
    }

    public function testNormalizeProjectUrlRejectsInvalid()
    {
        $this->expectException(InvalidArgumentException::class);
        normalize_project_url('not a url');
    }

    public function testNormalizeProjectUrlRejectsNonHttpScheme()
    {
        $this->expectException(InvalidArgumentException::class);
        normalize_project_url('ftp://example.com/file');
    }
