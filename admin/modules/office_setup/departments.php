 ...
 * adding multiple departments at once in a tabular grid.
 */
...
<div class="cms-drawer" id="formDrawer">
    <div class="cms-drawer-header">
        <h3><i class="fas fa-building"></i><span id="drawerTitle">Add Department</span></h3>
...
function openDrawer(btn) {
    ...
    if (btn) {
        ...
        document.getElementById('drawerTitle').textContent = 'Edit Department';
        document.getElementById('drawerBtnText').textContent = 'Update';
    } else {
        addBulkRow();
        document.getElementById('drawerTitle').textContent = 'Add Department';
