...
$loginData = [
    ...
    'off_day'           => implode(',', array_map('trim', (array) ($_POST['off_day'] ?? []))),
    'checkin'           => ($_POST['checkin'] ?? '') !== '' ? substr((string) $_POST['checkin'], 0, 8) : null,
    'checkout'          => ($_POST['checkout'] ?? '') !== '' ? substr((string) $_POST['checkout'], 0, 8) : null,
